...
class Recounted:
    ...
    `topics` is every part of the turn's narration that was built and not played — its sections, and what the
    user already answered through a dialog — which makes this line the
