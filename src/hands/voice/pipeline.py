...
SPOKEN_REPLY_INSTRUCTION = (
    ...
    "doing, and say what it amounts to rather than reading its steps out; when "
    "more comes back true, ask the user before reading on, and when working comes "
    "back true say what the session is in the middle of. When the user dictates something for a session, stage it "
